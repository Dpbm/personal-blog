...
![exemplo autômato](/image/image_251.png)

![verificando o valor 1100 usando uma árvore](/image/image_252.png)

como tivemos um estado final ao testar o valor 1100, esse valor é válido

![representação em formato de tabela](/image/image_253.png)
