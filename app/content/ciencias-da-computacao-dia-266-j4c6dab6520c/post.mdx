...
![image](/image/image_434.png)

> nesse caso, din(B) = 2 e dout(B) = 0

#### Problema de Königsberg

![[wikipedia](https://en.wikipedia.org/wiki/Seven_Bridges_of_K%C3%B6nigsberg)](/image/image_435.png)
