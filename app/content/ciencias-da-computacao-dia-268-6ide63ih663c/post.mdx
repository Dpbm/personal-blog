...
![image](https://cdn-images-1.medium.com/max/800/1*NXQxIn4IS0UsvdAMqxC7Zw.png)
...
![image](https://cdn-images-1.medium.com/max/800/1*IvJLAtYHvc4MWfbjP9grXg.png)

-   agora, para saber qual posição o valor k está (dentro das classes)
    você utiliza as formulas:

![image](https://cdn-images-1.medium.com/max/800/1*imeuCvXiuGH0bjQkpxs4uA.png)
