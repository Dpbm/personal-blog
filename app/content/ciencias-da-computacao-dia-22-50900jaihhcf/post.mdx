...
![numero de bits de paridade
para BCD](https://cdn-images-1.medium.com/max/800/1*GwXz8vAMYW1pGV4E5MVCpw.png)

![Tabela check
de paridade](https://cdn-images-1.medium.com/max/800/1*xiUlpBijgZ-8Q_C_AU_61Q.png)

agora você deve adicionar nas linhas quais quer números de k bits, com
exceção do 0 que sempre será 0, 0, 0, ... k

![valores com
k bits](https://cdn-images-1.medium.com/max/800/1*46NjHcxDA6xM1bc4rrwQgQ.png)

![tabela check de
paridade completa](https://cdn-images-1.medium.com/max/800/1*1U8zjKPllQMHUOYuNjau3A.png)
...
![criando a tabela do código
de Hamming](https://cdn-images-1.medium.com/max/800/1*9zYk2h2zGpOKt01ZWB9XQg.png)
...
![tabela do código
de Hamming](https://cdn-images-1.medium.com/max/800/1*hnLVq55dkmuuaAZee66R3Q.png)

agora preencha os m com os valores do código

![código BCD na tabela do código
de Hamming](https://cdn-images-1.medium.com/max/800/1*HpVFNX0GEIvuVOJBmScuIA.png)
...
![tabela do código de
Hamming pronta](https://cdn-images-1.medium.com/max/800/1*g3ULisIyH7KKGhT4YVdNPQ.png)
...
![detectando
o erro](https://cdn-images-1.medium.com/max/800/1*gxlfrWlbdH6Sr6dmkG2hxw.png)
