...
![numero de bits de paridade para BCD](/image/image_10.png)

![Tabela check de paridade](/image/image_11.png)

agora você deve adicionar nas linhas quais quer números de k bits, com
exceção do 0 que sempre será 0, 0, 0, ... k

![valores com k bits](/image/image_12.png)

![tabela check de paridade completa](/image/image_13.png)
...
![criando a tabela do código de Hamming](/image/image_14.png)
...
![tabela do código de Hamming](/image/image_15.png)

agora preencha os m com os valores do código

![código BCD na tabela do código de Hamming](/image/image_16.png)
...
![tabela do código de Hamming pronta](/image/image_17.png)
...
![detectando o erro](/image/image_18.png)
