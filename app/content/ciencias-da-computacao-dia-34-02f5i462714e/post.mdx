...
![exemplo de mapa de karnaugh](/image/image_59.png)

1 --- encontre todos os implicantes possíveis

![primeiro implicante](/image/image_60.png)

![segundo implicante](/image/image_61.png)

![terceiro implicante](/image/image_62.png)

![quarto implicante](/image/image_63.png)

![quinto implicante](/image/image_64.png)

![sexto implicante](/image/image_65.png)
...
![todos os implicantes não essenciais](/image/image_66.png)
...
![primeiro possível resultado](/image/image_67.png)

f2(a,b,c) = b'.c + a'.c' + a.b

![segundo possível resultado](/image/image_68.png)
...
![todos os essenciais](/image/image_69.png)

![não essencial 1](/image/image_70.png)

![não essencial 2](/image/image_71.png)
...
![primeira solução](/image/image_72.png)

f2(a,b,c) = a'.b + a.b' + a.c'

![segunda solução](/image/image_73.png)
