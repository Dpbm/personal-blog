...
### Ciências da computação 199

arquitetura de computadores --- registradores acumuladores

![image](https://cdn-images-1.medium.com/max/800/1*mWJlGclbOQKzier_6L0vNQ.png)
